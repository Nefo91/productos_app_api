...
public class ProductoAdapterRecyclerView
    ...
    public void onBindViewHolder(@NonNull ProductoViewHolder holder, int position) {
        ...
        holder.clave.setText("Marca: "+cardViewProducto.getClave());
        holder.name.setText("Nombre: " +cardViewProducto.getNombre());
        holder.precio.setText("PRECIO Q: "+cardViewProducto.getPrecio());
        holder.detalle.setText("Descripcion: "+cardViewProducto.getDetalle());
